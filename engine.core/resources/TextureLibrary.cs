...
namespace engine.core.resources
{
    public static class TextureLibrary
    {
        ...
        {
            var file = Filepaths.GetTextureFileInfo(filename);
            if (!file.Exists)
                throw new TextureException(StandardExceptions.NewFileNotFound(file));
            ...
            var textureBitmap = new Bitmap(file.FullName);
